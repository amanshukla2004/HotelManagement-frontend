...
const SkeletonRow = () => (
  <div className="grid grid-cols-12 gap-6 px-8 py-6 items-center animate-pulse border-b border-gray-50 bg-white">
    ...
    <div className="col-span-4 flex justify-end gap-2">
      {[1, 2, 3, 4].map((i) => (
        <div key={i} className="w-10 h-10 rounded-xl bg-gray-50" />
      ))}
    </div>
  </div>
);
...
const EmptyState = ({ onAdd }) => (
  <div className="flex flex-col items-center justify-center py-32 text-center px-4">
    ...
    <h3 className="text-2xl font-black text-[#0F172A] tracking-tighter mb-2 uppercase">
      No Hotels Found
    </h3>
    <p className="text-sm font-medium text-gray-400 max-w-xs mb-10 leading-relaxed">
      Add your first hotel property to start managing bookings and rooms in the
      Roomly system.
    </p>
    <button
      onClick={onAdd}
        ...
        {togglingId && (
          ...
          >
            <div className="bg-white rounded-[2rem] p-8 max-w-md w-full shadow-2xl flex flex-col items-center text-center space-y-6">
              ...
              <div>
                <h3 className="text-xl font-black text-[#0F172A] tracking-tighter uppercase mb-2">
                  Processing Update
                </h3>
                <p className="text-sm font-medium text-gray-500 leading-relaxed">
                  Please wait... Preparing hotel inventory for the next 365
                  days. This may take up to 3 minutes.
                </p>
              </div>
            </div>
          </motion.div>
        ...
        <div className="flex flex-col xl:flex-row xl:items-end justify-between gap-10">
          <div className="space-y-6">
            <div className="flex items-center gap-3">
              <span className="px-3 py-1 bg-[#0284C7]/10 text-[#0284C7] text-xs font-black uppercase tracking-[0.3em] rounded-md border border-[#0284C7]/10">
                Admin Portal
              </span>
            ...
            <h1 className="text-6xl font-black text-[#0F172A] tracking-tighter uppercase leading-none">
              Your Properties
            </h1>
            <p className="text-[#0284C7] font-black text-xs uppercase tracking-[0.4em]">
              Management interface for your hotels, room availability, and
              performance reports.
            </p>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-4">
            <div className="flex bg-white p-1 rounded-2xl border border-gray-100 shadow-sm">
              <button
                ...
                className={`p-2 rounded-xl transition-all ${viewMode === "list" ? "bg-[#0F172A] text-white shadow-lg" : "text-gray-400 hover:bg-gray-50"}`}
              >
                <List size={18} />
              </button>
              <button
                onClick={() => setViewMode("grid")}
                className={`p-2 rounded-xl transition-all ${viewMode === "grid" ? "bg-[#0F172A] text-white shadow-lg" : "text-gray-400 hover:bg-gray-50"}`}
              >
                <LayoutGrid size={18} />
              </button>
            </div>
          ...
          {isLoading ? (
            ...
            <div className="bg-white rounded-[3rem] border border-gray-100 shadow-[0_32px_80px_rgba(0,0,0,0.04)] overflow-hidden">
              ...
              <div className="grid grid-cols-12 gap-6 px-8 py-5 bg-gray-50/50 border-b border-gray-50">
                ...
                <div className="col-span-3 text-xs font-black text-gray-400 uppercase tracking-widest">
                  Property Details
                </div>
                <div className="col-span-2 text-xs font-black text-gray-400 uppercase tracking-widest">
                  Location
                </div>
                <div className="col-span-2 text-xs font-black text-gray-400 uppercase tracking-widest text-center">
                  Visibility
                </div>
                <div className="col-span-4 text-xs font-black text-gray-400 uppercase tracking-widest text-right">
                  Actions
                </div>
              </div>
                  ...
                  >
                    ...
                    <div className="col-span-4 flex items-center justify-end gap-2">
                      <button
                        ...
                        className="p-2.5 rounded-xl bg-[#0284C7]/5 text-[#0284C7] hover:bg-[#0284C7] hover:text-white transition-all group/btn"
                        title="Manage Rooms"
                      >
                        <BedDouble size={18} />
                      </button>
                      <button
                        onClick={() =>
                          navigate(`/admin/reports?hotelId=${hotel.id}`, {
                            state: { hotelName: hotel.name },
                          })
                        }
                        className="p-2.5 rounded-xl bg-amber-50 text-amber-600 hover:bg-amber-500 hover:text-white transition-all"
                      ...
                      <button
                        ...
                        className="p-2.5 rounded-xl hover:bg-gray-100 text-gray-400 hover:text-[#0F172A] transition-all"
                      >
                        <Edit2 size={16} />
                      </button>
                      <button
              ...
              {hotels.map((hotel, idx) => (
                ...
                >
                  <div className="aspect-video rounded-[1.5rem] bg-gray-50 overflow-hidden mb-6 relative">
                    <img
                      src={
                        hotel.photos?.[0] || "https://via.placeholder.com/300"
                      }
                    ...
                    <div className="absolute top-4 right-4 flex gap-2">
                      <button
                        onClick={() => openEdit(hotel)}
                        className="p-2.5 rounded-xl bg-white/20 backdrop-blur-xl text-white border border-white/20 hover:bg-white hover:text-[#0F172A] transition-all"
                      >
                        <Edit2 size={14} />
                      </button>
                    </div>
                    {!hotel.active && (
                      <div className="absolute inset-0 bg-[#0F172A]/60 backdrop-blur-sm flex items-center justify-center font-black text-white text-xs uppercase tracking-[0.3em]">
                        OFFLINE
                      </div>
                    )}
                  </div>
                  ...
                  <div className="space-y-4">
                    <div>
                      <div className="flex items-center justify-between mb-1">
                        ...
                        <span
                          className={`text-xs font-black uppercase tracking-widest px-2 py-1 rounded-md ${hotel.active ? "bg-green-50 text-green-700" : "bg-gray-100 text-gray-400"}`}
                        >
                    ...
                    <div className="grid grid-cols-2 gap-3 pt-2">
                      <button
                        ...
                        className="flex items-center justify-center gap-2 py-3 bg-[#0F172A] text-white rounded-xl text-xs font-black uppercase tracking-widest hover:bg-[#0284C7] transition-all"
                      >
                        Rooms
                      </button>
                      <button
                        ...
                        className="flex items-center justify-center gap-2 py-3 bg-gray-50 text-[#0F172A] rounded-xl text-xs font-black uppercase tracking-widest hover:bg-gray-100 transition-all"
                      >
                        Reports
                      </button>
                    </div>
