      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <div className="space-y-6 text-gray-500 font-medium">
            <p>
              At Roomly, we take your privacy seriously. This policy describes
            ...
            <p>
              ...
              users. We collect information in the following ways: information
              you give us, and information we get from your use of our services.
            </p>
            <h2 className="text-xl font-black text-[#0F172A] tracking-tight uppercase">
            ...
            <p>
              ...
              and to protect Roomly and our users.
            </p>
          </div>
        </motion.div>
      </div>
