      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          <div className="flex items-center gap-4 mb-10">
            ...
            <div>
              <h1 className="text-4xl font-black text-[#0F172A] tracking-tighter uppercase leading-none">Cookie Policy</h1>
          ...
          <div className="space-y-6 text-gray-500 font-medium">
            <p>This Cookie Policy explains how Nox uses cookies and similar technologies to recognize you when you visit our website.</p>
            <h2 className="text-xl font-black text-[#0F172A] tracking-tight uppercase">1. What are cookies?</h2>
            <p>Cookies are small data files that are placed on your computer or mobile device when you visit a website. Cookies are widely used by website owners in order to make their websites work, or to work more efficiently, as well as to provide reporting information.</p>
            <h2 className="text-xl font-black text-[#0F172A] tracking-tight uppercase">2. Why do we use cookies?</h2>
