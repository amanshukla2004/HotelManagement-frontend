      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <div className="space-y-6 text-gray-500 font-medium">
            <p>
              Welcome to Roomly! These terms and conditions outline the rules
              and regulations for the use of Roomly's Website.
            </p>
            <h2 className="text-xl font-black text-[#0F172A] tracking-tight uppercase">
              1. Terms
            </h2>
            <p>
              By accessing this Website, accessible from roomlystays.com, you
            ...
            <p>
              ...
              materials on Roomly's Website for personal, non-commercial
