...
import {
  ...
  Star, Shield, ShieldCheck, Headphones, Zap, ChevronRight,
  Building2, Wifi, Utensils, Car, Waves, Dumbbell,
...
const AMENITY_ICONS = {
  WIFI: <Wifi size={14} />, POOL: <Waves size={14} />,
  GYM: <Dumbbell size={14} />, PARKING: <Car size={14} />,
      ...
      >
        ...
        <AnimatePresence>
          {skyline.map(b => (
            <motion.div
              key={b.id}
              initial={{ x: b.x - b.type.width / 2, y: b.y, opacity: 0, scaleY: 0 }}
              animate={{ x: b.x - b.type.width / 2, y: b.targetY, opacity: 0.85, scaleY: 1 }}
              exit={{ opacity: 0 }}
              transition={{ type: 'spring', stiffness: 90, damping: 14, mass: 1.2 }}
              style={{ originY: 1, position: 'absolute', width: b.type.width, height: b.type.height, backgroundColor: b.type.bg, boxShadow: '0 -4px 40px rgba(0,0,0,0.4)', borderRadius: '4px 4px 0 0' }}
            ...
            >
              <div className="w-full h-full p-1.5 grid grid-cols-2 gap-1 content-start opacity-20">
                {[...Array(30)].map((_, i) => <div key={i} className="bg-white h-2.5 rounded-sm" />)}
              </div>
            </motion.div>
          ))}
        </AnimatePresence>
          ...
          {role === 'HOTEL_MANAGER' ? (
            ...
            >
              <div className="bg-white/10 backdrop-blur-3xl border border-white/20 rounded-[3rem] p-8 md:p-12 shadow-[0_48px_100px_rgba(0,0,0,0.5)] text-center space-y-8">
                ...
                <div className="space-y-2">
                  <h2 className="text-3xl font-black text-white tracking-tighter uppercase">Administrative Hub</h2>
                  <p className="text-white/50 text-sm font-medium">Welcome back. Manage your properties, monitor inventory, and track performance from your dashboard.</p>
                </div>
                <button 
            ...
            <div className="bg-white/10 backdrop-blur-3xl border border-white/20 rounded-[3rem] p-4 shadow-[0_48px_100px_rgba(0,0,0,0.5)]">
              <div className="bg-white rounded-3xl overflow-hidden flex flex-col lg:flex-row items-stretch divide-y lg:divide-y-0 lg:divide-x divide-gray-100">
                ...
                <div 
                  ...
                  onClick={() => document.getElementById('in-input').showPicker()}
                >
                ...
                <div 
                  className="flex-1 relative group flex flex-col justify-center px-6 py-4 hover:bg-gray-50 transition-colors cursor-pointer"
                  onClick={() => document.getElementById('out-input').showPicker()}
                >
            ...
            <div className="mt-8 flex justify-center">
              ...
              >
                ...
                <span className="tracking-[0.2em] uppercase">Find Your Hotel</span>
                <ArrowRight size={28} className="opacity-0 -translate-x-4 group-hover:opacity-100 group-hover:translate-x-0 transition-all font-black" />
              </motion.button>
              </div>
            </motion.form>
          )}
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-white/50 text-sm max-w-md">
              Join thousands of property managers who trust Nox to fill their rooms, manage their inventory, and grow their revenue.
            </p>
      ...
      {role !== 'HOTEL_MANAGER' && (
        ...
        >
          ...
          <p className="text-gray-500 mb-8 max-w-md mx-auto">
            Thousands of hotels, one seamless platform. Find your perfect stay in seconds.
          </p>
          <button
