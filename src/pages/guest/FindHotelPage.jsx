...
const FindHotelPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC]">
      ...
      {/* ── HERO SECTION ─────────────────────────────────────────────────── */}
      <section className="relative w-full py-24 md:py-32 overflow-hidden bg-[#0F172A]">
        <div className="absolute inset-0 opacity-20 bg-[radial-gradient(circle_at_center,_#0284C7_0%,_transparent_70%)]" />
        ...
        <div className="max-w-5xl mx-auto px-4 relative z-10 text-center">
          ...
          >
            ...
            <span className="px-3 py-1 bg-white/10 rounded-full text-[10px] font-black tracking-[0.2em] text-[#0284C7] uppercase border border-white/10 backdrop-blur-sm">
              Explore the World
            </span>
          </motion.div>
          ...
          >
            Find your <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#0284C7] to-[#F97316]">next adventure</span>
          </motion.h1>
          ...
          >
            <div className="bg-white p-2 rounded-[28px] shadow-2xl flex items-center group focus-within:ring-4 focus-within:ring-[#0284C7]/10 transition-all">
              <div className="flex-1 flex items-center px-6">
                <Search size={20} className="text-gray-400 mr-4 group-focus-within:text-[#0284C7] transition-colors" />
                <input 
                  value={city}
                  onChange={e => setCity(e.target.value)}
                  required
                  placeholder="Where are you dreaming of going?"
                  className="w-full py-4 text-sm font-bold text-[#0F172A] outline-none placeholder:text-gray-300"
                />
              </div>
              <button 
                type="submit"
                className="bg-[#0F172A] hover:bg-[#0284C7] text-white px-8 py-4 rounded-[22px] font-black text-xs uppercase tracking-widest transition-all shadow-lg active:scale-95 flex items-center gap-2"
              >
      ...
      <section className="max-w-7xl mx-auto px-4 -mt-16 relative z-20 pb-20">
        <div className="flex items-center justify-between mb-10">
          <div>
            <h2 className="text-2xl font-black text-[#0F172A] tracking-tighter leading-none">Popular Destinations</h2>
            ...
            >
              ...
              <div className="absolute bottom-10 left-10 right-10">
                <div className="flex items-center gap-2 mb-3">
                  <span className="px-2 py-0.5 bg-[#0284C7] text-white text-xs font-black uppercase tracking-widest rounded-md">
                    {city.hotels} stays
                  </span>
                  <div className="flex items-center text-[#F97316] scale-75">
      ...
      <section className="bg-white py-24 mb-20 border-y border-gray-100">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-black text-[#0F172A] tracking-tighter mb-4">Travel Collections</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {COLLECTIONS.map((col, idx) => (
              <motion.div
                ...
                className="p-8 rounded-[2rem] bg-gray-50 border border-transparent hover:border-[#0284C7]/10 transition-all group"
              >
                ...
                <h4 className="text-lg font-black text-[#0F172A] mb-2">{col.title}</h4>
                <p className="text-sm text-gray-500 font-bold tracking-tight mb-6">{col.count}</p>
                <div className="w-8 h-8 rounded-full bg-white flex items-center justify-center text-gray-300 group-hover:bg-[#0284C7] group-hover:text-white transition-all shadow-sm">
                  <ArrowRight size={14} />
                </div>
              </motion.div>
            ))}
      ...
      <section className="max-w-5xl mx-auto px-4 py-20 bg-[#0F172A] rounded-[3rem] mb-20 overflow-hidden relative shadow-2xl">
         <div className="absolute top-0 right-0 w-64 h-64 bg-[#0284C7]/10 blur-[80px] -mr-32 -mt-32" />
         <div className="absolute bottom-0 left-0 w-64 h-64 bg-[#0284C7]/10 blur-[80px] -ml-32 -mb-32" />
         
         <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center relative z-10">
           <div className="space-y-4">
              <div className="flex justify-center"><Map className="text-[#0284C7]" size={28} /></div>
           ...
           <div className="space-y-4 border-y md:border-y-0 md:border-x border-white/10 py-10 md:py-0">
              <div className="flex justify-center"><TrendingUp className="text-[#0284C7]" size={28} /></div>
           ...
           <div className="space-y-4">
              <div className="flex justify-center"><Sparkles className="text-[#0284C7]" size={28} /></div>
