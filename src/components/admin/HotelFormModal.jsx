...
const HotelFormModal = ({
  ...
  const inputClass =
    "w-full bg-gray-50 border border-gray-100 rounded-2xl px-4 py-3.5 text-xs font-bold text-[#0F172A] outline-none focus:border-[#0284C7] focus:ring-4 focus:ring-[#0284C7]/5 transition-all placeholder:text-gray-300";
  const labelClass =
  ...
  return (
    <Modal
      ...
      subtitle={
        isEditing
          ? `Modifying Record: ${initialData?.name}`
          : "Register a new property to the Roomly management system."
      }
      width="max-w-3xl"
    >
      <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-10">
        ...
        <section className="space-y-6">
          <div className="flex items-center gap-3">
            ...
            <h3 className="text-xs font-black text-[#0284C7] uppercase tracking-[0.3em]">
              Basic Information
            </h3>
          </div>
          ...
          <div className="grid grid-cols-1 gap-6">
            <div>
              ...
              <input
                ...
                placeholder="e.g., Roomly Grand Royale"
              />
              {errors.name && (
        ...
        <section className="space-y-6">
          <div className="flex items-center gap-3">
            ...
            <h3 className="text-xs font-black text-[#F97316] uppercase tracking-[0.3em]">
              Contact & Location
            </h3>
          </div>
        ...
        <section className="space-y-6">
          <div className="flex items-center gap-3">
            ...
            <h3 className="text-xs font-black text-green-600 uppercase tracking-[0.3em]">
              Amenities & Specs
            </h3>
          </div>
        ...
        <section className="space-y-6">
          <div className="flex items-center gap-3">
            ...
            <h3 className="text-xs font-black text-purple-600 uppercase tracking-[0.3em]">
              Photos & Gallery
            </h3>
          </div>
                  ...
                  <div className="flex-1 flex gap-3">
                    ...
                    {photos.length > 1 && (
                      <button
                        ...
                        className="p-3.5 bg-red-50 text-red-400 hover:bg-red-500 hover:text-white rounded-2xl transition-all self-start h-[46px]"
                      >
                        <Trash2 size={16} />
                      </button>
                    )}
